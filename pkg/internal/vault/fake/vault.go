...
type Vault struct {
	NewFn                           func(string, configreader.ConfigReader, cmapi.GenericIssuer) (*Vault, error)
...
func New() *Vault {
	...
	v.NewFn = func(string, configreader.ConfigReader, cmapi.GenericIssuer) (*Vault, error) {
		return v, nil
	}
