...
import (
	...
	"kubeops.dev/csi-driver-cacerts/client/clientset/versioned/scheme"

	rest "k8s.io/client-go/rest"
)

type CacertsV1alpha1Interface interface {
	RESTClient() rest.Interface
	CAProviderClassesGetter
}
...
func (c *CacertsV1alpha1Client) CAProviderClasses(namespace string) CAProviderClassInterface {
	return newCAProviderClasses(c, namespace)
}

// NewForConfig creates a new CacertsV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new CacertsV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CacertsV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &CacertsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CacertsV1alpha1Client for the given config and
...
func New(c rest.Interface) *CacertsV1alpha1Client {
	return &CacertsV1alpha1Client{c}
}
